...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="${webRoot}/mystyle/profile_my.css">
  <!-- Bootstrap 3.3.6 -->
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" action="${webRoot }/userController/update" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" class="form-control" disabled="disabled" value="${userEntity.username }" id="inputName" placeholder="Name">
                    </div>
                  </div>
                  <div class="form-group">
